              ...
              <Grid container spacing={1}>
                <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                  ...
                  <div className="d-flex mt-3">
                    ...
                    <Typography className="ms-2">bkrabbe1d@home.pl</Typography>
                  </div>
                  <div className="d-flex mt-3">
                ...
                <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                  <div className="d-flex mt-3">
                    <Typography className="fw-semibold">Horoscope:</Typography>
                    <Typography className="ms-2">bkrabbe1d</Typography>
                  </div>
                  <div className="d-flex mt-3">
                    <Typography className="fw-semibold">Occupation:</Typography>
                    <Typography className="ms-2">bkrabbe1d</Typography>
                  </div>
                  <div className="d-flex mt-3">
